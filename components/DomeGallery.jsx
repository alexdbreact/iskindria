...
const DEFAULT_IMAGES = [
  ...
  {
    src: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?q=80&w=774&auto=format&fit=crop',
    alt: 'Alexandria Mediterranean view'
  },
  {
    src: 'https://images.unsplash.com/photo-1572252009286-268acec5ca0a?q=80&w=774&auto=format&fit=crop',
  ...
  useEffect(() => {
    ...
    const loop = time => {
      ...
      if (
        ...
        !isEnlarging &&
        performance.now() - lastDragEndAt.current > 400
      ) {
          ...
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                ...
                >
                  <img src={it.src} draggable={false} alt={it.alt || 'Gallery tile'} />
                </div>
              </div>
            ))}
          </div>
